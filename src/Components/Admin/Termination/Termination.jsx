...
useEffect(() => {
  const fetchEmployees = async () => {
    ...
    try {
      ...
      setEmployeeData(response.data.data); // Assuming data is an array of employee objects { id, name }
    } catch (error) {
    ...
    <div className=" min-h-screen">
      <div className="container mx-auto py-6 px-4">
        ...
        <div className="text-gray-500 text-sm md:text-base text-yellow-600">
          Dashboard / <span className="text-gray-700 font-medium text-yellow-600">Termination</span>
        </div>
